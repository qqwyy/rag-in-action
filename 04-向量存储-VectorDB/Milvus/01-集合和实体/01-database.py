...
# ——————————————
# try:
#     client.create_database(db_name="wyy_database_1")
#     print("✓ wyy_database_1 创建成功")
...
#     db_name="wyy_database_1",
#     properties={"database.max.collections": 10}
# )
# print("✓ 已为 wyy_database_1 限制最大集合数为 10")
...
# client.use_database(db_name="wyy_database_2")
# print("✓ 已切换当前数据库为 wyy_database_2")
